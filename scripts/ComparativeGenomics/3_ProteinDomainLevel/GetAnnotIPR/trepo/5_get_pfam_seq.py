...
try:
    ...
    # testing
    gene_id_list = f"""output/interproscan/processed_data/trepo/{pfam}_geneid.csv"""
    #proteome_fasta = "resources/Genome/HIN.faa"
    proteome_fasta = "resources/Genome/trepo.faa"

    protein_fasta= f"""output/interproscan/processed_data/trepo/{pfam}.faa"""
